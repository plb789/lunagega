...
enum 
{
	...
	eNewCharacterCheckName,     /// 쨩천쨌횓쩔챤 횆쨀쨍짱횇횒 ?횑쨍�?횁횩쨘쨔횄쩌횇짤 
	eForcedDisconnect,          /// 째짯횁짝쨌횓 짹창횁쨍?�?첬쨍�?짼첨?�?
	eSetCurMaxCount,			/// 횉철?�?�?첬쩔�?Max?�?첬쩌�?짹창쨌횕
	eLoginMapInfoSearchForName, /// 횆쨀쨍짱쨍챠?쨍쨌�?횁짖쩌횙쩔짤쨘횓쨔횞 쨍횎쨔첩횊짙 쩐챵쩐챤�?짹창
	eSavePoint,					/// SavePoint 
	eUnRegistLoginMapInfo,		/// 쨍횎쩔징쩌짯 쨀짧째징쨍�?쩍횉횉횪횉횗쨈횢
	eMapUserUnRegistMapInfo,	/// 쨍횎쩌짯쨔철 횁쩐쨌찼쩍횄 쩍횉횉횪
	eFriendGetTargetMemeberIDX,	/// 횆짙짹쨍 쨉챤쨌횕/쨩챔횁짝쩍횄 횇쨍째횢 횉횄쨌쨔?횑쩐�?쩐횈?횑쨉�?쩐챵쩐챤쩔횒쩌짯 쨍횧쩍횄횁철 
	eFriendAdd,					/// 횆짙짹쨍 쨉챤쨌횕
	eFriendIsValidTarget,		/// 횆짙짹쨍 쨉챤쨌횕 횉횘쩌철 ?횜쨈횂횁�?

	eFriendDel,					/// 횆짙짹쨍 쨩챔횁짝
	eFriendDelID,				/// 횆짙짹쨍 쨩챔횁짝 (쩐횈?횑쨉챨쨌�?
	eFriendDelList,				/// 횆짙짹쨍쨍짰쩍쨘횈짰 쨩챔횁짝(횆쨀쨍짱횇횒 쨩챔횁짝쩍횄)
	eFriendNotifyLogin,			/// 쨌횓짹횞?�?쩐횏쨍짼
	eFriendGetFriendList,		/// 횆짙짹쨍쨍짰쩍쨘횈짰
	eFriendGetLoginFriends,		/// 쨌횓짹횞?횓쨉횉쩐�?횜쨈�?횆짙짹쨍 쩐횏쩐횈�?짹창
	eNoteIsNewNote,				
...
//	
	eAgentDown,					/// 쩔징?�?체횈�?횇째쨍챕 횉횠쨈챌 쩔징?�?체횈짰쩔�?쩌횙횉횗 쩐횜쨉챕 쨌횓짹횞 쩐횈쩔척 횄쨀쨍짰
	...
	// desc_hseos_紐ъ뒪?�???1
	// S 紐ъ뒪?�???異붽? added by hseos 2007.05.29
	eInitMonstermeterInfoOfDB,
	// E 紐ъ뒪?�???異붽? added by hseos 2007.05.29

	// desc_hseos_?깅�?좏깮01
	// S ?깅�?좏깮 異붽? added by hseos 2007.06.15
	eGetUserSexKind,				// RGetUserSexKind
	// E ?깅�?좏깮 異붽? added by hseos 2007.06.15


	// desc_hseos_?�?�?1
	// S ?�?�?異붽? added by hseos 2007.07.09	2007.07.14
	eFamily_LoadInfo,
	eFamily_SaveInfo,
...
//-------------
	...
	// 080812 LYW --- AgentDBMsgParser : 소환�?db 업데이트 처리 추가.

	eSiegeRecallUpdate,

	// 080813 LYW --- AgentDBMsgParser : 소환�?db 정보 로드 처리 추가.
	eSiegeRecallLoad,

	// 080831 LYW --- AgentDBMsgParser : 소환�?db 정보 추가 처리 추가.
	eSiegeRecallInsert,

	// 080831 LYW --- AgentDBMsgParser : 소환�?db 정보 삭제 처리 추가.
	eSiegeRecallRemove,

	// 090525 ShinJS --- 이름으로 파티초대�?DB 검�?처리 추가
...
// 100305 ONS 허락여부�?묻지않고 친구�?추가하도�?수정.
